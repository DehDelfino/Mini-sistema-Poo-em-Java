public class Banco {
    ...
    Cliente Cliente1 = NewCliente();
    Cliente1.agencia = 332
    Cliente1.numero = 123456
    Cliente1.descricao = "Salgadinho na esquinha"
    Cliente1.valor = 
    Cliente1.data =


    Cliente Cliente2 = NewCliente();

    Cliente Cliente3 = NewCliente();
